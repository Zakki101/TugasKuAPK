...
public class HelperKalender extends SQLiteOpenHelper{
        ...
        private static final String KEY_RINCIAN = "rincian";
        private static final String KEY_TGL_EVENT_MULAI = "tanggal_event_mulai";
        private static final String KEY_TGL_EVENT_SELESAI = "tanggal_event_selesai";
        private static final String KEY_JAM_EVENT_MULAI = "jam_event_mulai";
        private static final String KEY_JAM_EVENT_SELESAI = "jam_event_selesai";
        ...
        public HelperTugas(Context context) {
